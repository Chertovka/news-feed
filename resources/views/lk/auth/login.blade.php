...
@section('content')
    <div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
        <div class="bg-white w-96 shadow-xl rounded p-5">
            ...
            <form method="POST" action="{{ route("lk.login_process") }}" class="space-y-5 mt-5">
                @csrf
                ...
                <div>
                    <a href="{{ route("admin.login") }}"
                       class="font-medium text-blue-900 hover:bg-blue-300 rounded-md p-2">Вход в админ. панель</a>
                </div>

                <div>
                    <a href="{{ route("login") }}"
                       class="font-medium text-blue-900 hover:bg-blue-300 rounded-md p-2">Вход на сайт</a>
                </div>
